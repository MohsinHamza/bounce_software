  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Users", style: AppTextStyle.bodyText,),
      ),
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  Text('Users' , style: AppTextStyle.greyBodyText,)  ,
                  Text('63 Users' , style: AppTextStyle.greyBodyText,)
                ],
              ),
              SizedBox(height: 10,),
...
class _RoleContainerWidgetState extends State<RoleContainerWidget> {
  List<bool> isSelected = List.generate(63, (index) => false);
          ...
          return Column(
            children: [
              Container(
                height: 40,
                child: ListTile(
                  leading: Image.asset('assets/pngs/user.png',),
                  title: Text('@Admin ${index + 1}#1234',style: AppTextStyle.bodyText,),
                  onTap: () {
                    setState(() {
                      isSelected[index] = !isSelected[index];
                    });
                  },
                  trailing: index == 63 && isSelected.contains(false)
                      ? null
                      : isSelected[index]
